...
const el_2 = document.createElement("link");
el_2.setAttribute("rel", `icon`);
el_2.setAttribute("type", `image/png`);
el_2.setAttribute("sizes", `32x32`);
el_2.setAttribute("href", `/favicon.png`);
